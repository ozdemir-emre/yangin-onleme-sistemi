...
<html lang="en">
<head>
  <title>Server Odası Durum</title>
  <meta charset="utf-8">
...
<h1 align="center" class="mt-5">404 Sayfası Aradığınız Sayfa Bulunamadı</h1>
<p class="center">
 <button class="btn btn-info btn-xs" id="restart">Yeniden Başlat</button>
</p>
  ...
  Game.prototype = {
    ...
    draw: function() {
      ...
      if (this.lost) {
        ...
        screen.fillText("Tuh Be Oluyordu", gameSize.width / 2, gameSize.height / 2);
        screen.font = "20px Lucida Console";
        screen.fillText("Puan: " + kills, gameSize.width / 2, gameSize.height / 2 + 30);
